...
print('evaluating resize')
group = '5_best'
models_dir = f'./../models/cnn_models/{group}/single/'
model_name = 'best_model.zip'
meta_name = 'meta.json'
save_name = 'domain_randomized.csv'
rewards_dir = f'./rewards/cnn_models/{group}'
tuned_method = 'grid'
...
for meta_dir, model_dir in zip(metas, models):
    ...
    env_source = create_env(meta, "CustomHopper-source-v0")
    env_target = create_env(meta, "CustomHopper-target-v0")
